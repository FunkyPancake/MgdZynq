...
#
# Generated by Vivado on Fri Dec 22 18:19:40 CET 2023
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/MgdZynq/ECS"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/MgdZynq/vivado/mxdmdg"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/MgdZynq/ECS"]" $obj
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.819277",
   "Default View_TopLeft":"10,-6",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1140 -y 40 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1140 -y 60 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 230 -y 320 -defaultsOSRD
preplace inst crank_cam_sim_0 -pg 1 -lvl 3 -x 990 -y 140 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 650 -y 120 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 2 -x 650 -y 420 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 460 460 250 850
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 N 400
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 470 270 860
preplace netloc processing_system7_0_DDR 1 1 3 NJ 240 830 40 N
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 260 840 60 N
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 440J 60n
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 NJ 120
levelinfo -pg 1 0 230 650 990 1140
pagesize -pg 1 -db -bbox -sgen 0 0 1260 530
"
}
  ...
  set_property PFM.CLOCK {FCLK_CLK0 {id "0" is_default "true" proc_sys_reset "FCLK_RESET_0N" status "fixed" freq_hz "100000000"}} [get_bd_cells /processing_system7_0]
...
cr_bd_mxdmdg ""
set_property PFM_NAME "vendor:lib:mxdmdg:1.0" [get_files mxdmdg.bd ] 
...
if { [get_property IS_LOCKED [ get_files -norecurse [list mxdmdg.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/MgdZynq/vivado/mxdmdg/mxdmdg.gen/sources_1/bd/mxdmdg/hdl/mxdmdg_wrapper.v" ]
} else {
